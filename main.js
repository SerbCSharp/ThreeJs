...
const bricksColorTexture = textureLoader.load('/bricksColor.jpg')
bricksColorTexture.colorSpace = THREE.SRGBColorSpace
const bricksAmbientOcclusionTexture = textureLoader.load('/bricksAmbientOcclusion.jpg')
const bricksNormalTexture = textureLoader.load('/bricksNormal.jpg')
const bricksRoughnessTexture = textureLoader.load('/bricksRoughness.jpg')

const grassColorTexture = textureLoader.load('/grassColor.jpg')
grassColorTexture.colorSpace = THREE.SRGBColorSpace
const grassAmbientOcclusionTexture = textureLoader.load('/grassAmbientOcclusion.jpg')
const grassNormalTexture = textureLoader.load('/grassNormal.jpg')
const grassRoughnessTexture = textureLoader.load('/grassRoughness.jpg')
