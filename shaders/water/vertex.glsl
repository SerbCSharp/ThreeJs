...
float wareElevation(vec3 position)
{
...
void main()
{
    ...
    // Elevation
    float elevation = wareElevation(modelPosition.xyz);
    modelPosition.y += elevation;
    modelPositionA.y += wareElevation(modelPositionA);
    modelPositionB.y += wareElevation(modelPositionB);
